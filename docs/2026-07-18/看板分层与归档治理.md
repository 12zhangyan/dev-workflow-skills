...
- **前置条件**：保持根目录 `project-html/` 与 `skills/dev-doc/assets/board/` 外壳字节一致；行为变化必须提升 `BOARD_VERSION`。
...
| `skills/dev-doc/assets/board/*` | 修改 | 同步上述看板外壳模板，供安装后的各 skill 使用 |
| `skills/dev-doc/SKILL.md`、`reference.md` | 修改 | 更新构建和导出行为说明 |
...
- [x] 将所有外壳变更同步到 `skills/dev-doc/assets/board/` 并提升 `BOARD_VERSION`。
...
- 安装模板：`skills/dev-doc/assets/board/` 对应外壳文件。
- 工作流说明：`skills/dev-doc/`、`skills/bug-fix/SKILL.md`、`skills/biz-flow/SKILL.md`、`skills/code-reading/SKILL.md`。
