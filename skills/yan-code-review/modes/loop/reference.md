...
task: <任务名>
source: <yan-dev-doc / review-task / 当前 diff>
...
nextCommand: <Passed 且无未关闭 CR/IM：使用 yan-project-analysis skill，mode=understanding，基于 source 和当前实现生成代码地图后人工 review；Blocked：人工：补齐 blocker 后重新运行 yan-code-review skill，mode=loop；EnvironmentBlocked：修复环境后重新运行 yan-code-review skill，mode=loop；deferred-next-batch：使用 yan-code-review skill，mode=loop，继续下一批>
