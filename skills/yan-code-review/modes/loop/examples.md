...
```text
使用 yan-code-review skill，mode=loop，基于 docs/2026-07-11/APP收货拆分.md 审查并修复当前工作区，直到没有 Critical/Important。
```
...
```text
使用 yan-code-review skill，mode=loop quick，审查并修复当前工作区的小改动。
```
