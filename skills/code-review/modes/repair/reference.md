...
nextCommand: <有 blocked：人工确认；有 deferred-next-batch：使用 code-review skill，mode=repair，继续下一批；只有普通 deferred 或无未关闭 CR/IM：使用 project-analysis skill，mode=understanding，继续，普通 deferred 不自动重跑>
...
| Prompt | 期望 |
|--------|------|
| `使用 code-review skill，mode=repair，按这些 findings 直接修复：CR-1 ...` | 触发，直接修复 |
