...
```text
使用 code-review skill，mode=package，基于 docs/2026-07-01/sms-login.md 生成 Review 任务包
```
...
使用 code-review skill，mode=check，审查 docs/review-fix/2026-07-01/sms-login-review-task.md
...
- 技能化入口：可直接交给其他 AI 使用 `code-review mode=check` 审查任务包。
...
`code-review mode=package` 第二阶段会生成：
