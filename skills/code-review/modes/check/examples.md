...
```text
使用 code-review skill，mode=check，审查 docs/review-fix/2026-07-02/sms-login-review-task.md
```
...
nextCommand: 使用 code-review skill，mode=repair，根据 CR-1 直接修复并验证
...
openFindings: IM-1
next: 将 findings 贴回 review-fix 汇总，或交给 review-repair 直接修复
nextCommand: 使用 code-review skill，mode=repair，根据 IM-1 直接修复并验证
