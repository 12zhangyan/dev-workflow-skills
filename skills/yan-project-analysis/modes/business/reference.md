...
next: 测试设计 / yan-dev-doc 开发方案 / review-fix 审查任务包 / code-reading 调用链阅读
nextCommand: 使用 yan-dev-doc skill 基于 docs/biz-flow/<日期>/<业务名>.md 生成可执行开发方案
...
2. 发现业务冲突或需要开发改造：运行 `/yan-dev-doc docs/biz-flow/<日期>/<业务名>.md` 形成开发方案。
