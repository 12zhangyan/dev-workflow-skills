...
const reviewCheckReference = path.join(root, 'skills', 'review-check', 'reference.md');
...
const reviewFixReference = path.join(root, 'skills', 'review-fix', 'reference.md');
const reviewFixSkill = path.join(root, 'skills', 'review-fix', 'SKILL.md');
...
const reviewRepairReference = path.join(root, 'skills', 'review-repair', 'reference.md');
const reviewRepairSkill = path.join(root, 'skills', 'review-repair', 'SKILL.md');
