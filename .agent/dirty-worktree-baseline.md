...
## main...origin/main
 ...
 M skills/dev-doc/SKILL.md
 M skills/dev-doc/assets/board/board-add.js
 M skills/dev-doc/assets/board/build.js
 M skills/dev-doc/assets/board/css/board.css
 M skills/dev-doc/assets/board/data/changes.js
 M skills/dev-doc/assets/board/index.html
 M skills/dev-doc/assets/board/js/board.js
 M skills/dev-doc/reference.md
?? docs/2026-07-18/
?? project-html/data/details/
?? scripts/check-board-behavior.js
?? skills/dev-doc/assets/board/data/details/
```
...
- `project-html/` 与 `skills/dev-doc/assets/board/` 是同步资产；修改其中一处时必须按项目规则同步另一处并运行 `node scripts/check-board-sync.js`。
